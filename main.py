...
def parse_args(argv=None) -> argparse.Namespace:
    ...
    parser.add_argument("--host", default=DEFAULT_HOST, help="Adres nasłuchu serwera.")
    parser.add_argument("--port", type=int, default=DEFAULT_PORT, help="Port nasłuchu.")
    parser.add_argument(
...
def main(argv=None) -> None:
    ...
    print(f"Serwer działa na http://{args.host}:{args.port} (Ctrl+C kończy).")
    try:
        httpd.serve_forever()
